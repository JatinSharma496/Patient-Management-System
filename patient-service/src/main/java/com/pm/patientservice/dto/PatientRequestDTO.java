...
public class PatientRequestDTO
{
   ...
   private String registrationDate;
    ...
    public @NotBlank(message = "Registered date is required") String getRegistrationDate() {
        return registrationDate;
    }

    public void setRegistrationDate(@NotBlank(message = "Registered date is required") String registrationDate) {
    ...
    public @NotBlank(message = "Address id required") String getAddress() {
        return address;
    }

    public void setAddress(@NotBlank(message = "Address id required") String address) {
